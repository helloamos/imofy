...
class ContractTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract_type" do
    assert_difference('ContractType.count') do
      post contract_types_url, params: { contract_type: { description: @contract_type.description, nom: @contract_type.nom } }
    end
  ...
  test "should update contract_type" do
    patch contract_type_url(@contract_type), params: { contract_type: { description: @contract_type.description, nom: @contract_type.nom } }
