...
ActiveRecord::Schema.define(version: 20170909103303) do
  ...
  create_table "inquiry_mails", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_inquiry_mails_on_property_id"
    t.index ["user_id"], name: "index_inquiry_mails_on_user_id"
  end
